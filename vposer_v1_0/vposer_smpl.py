...
class VPoser(nn.Module):
    def __init__(self, num_neurons, latentD, data_shape, use_cont_repr=True):       # 512, 32, [1, 21, 3]
    ...
    def matrot2aa(pose_matrot):
        ...
        pose = tgm.rotation_matrix_to_angle_axis(homogen_matrot).view(batch_size, -1, 3).contiguous()
        return pose
